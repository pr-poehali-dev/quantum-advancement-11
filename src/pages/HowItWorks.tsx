...
const STEPS = [
  ...
  { num: 3, status: 'ожидает оплаты', color: 'bg-gold-500/20 text-gold-300' },
  ...
  return (
    <div className="min-h-screen bg-choco-950 text-white">
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-8 py-10 sm:py-16 space-y-14">
        ...
        {/* Заголовок */}
        <div>
          <div className="text-gold-400 text-sm font-medium uppercase tracking-widest mb-3">Руководство</div>
        ...
        <section>
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            <div className="bg-white/5 border border-white/10 rounded-2xl p-6">
              <div className="text-gold-400 font-semibold mb-2">Распив</div>
            ...
            <div className="bg-white/5 border border-white/10 rounded-2xl p-6">
              <div className="text-gold-400 font-semibold mb-2">Совместные закупки</div>
              <p className="text-white/60 text-sm leading-relaxed">
        ...
        <section>
          <h2 className="text-xl font-semibold mb-4 flex items-center gap-2">
            <span className="w-7 h-7 rounded-full bg-gold-500/20 text-gold-400 text-sm flex items-center justify-center font-bold">1</span>
            Оформление заказа
          </h2>
          <div className="bg-white/5 border border-white/10 rounded-2xl p-6 space-y-3 text-white/70 leading-relaxed">
            <p>
              ...
              <Link to="/register" className="text-gold-400 hover:underline">регистрацию</Link>{' '}
              на главной странице. После чего можно перейти в{' '}
              <Link to="/catalog" className="text-gold-400 hover:underline">каталог</Link>,
        ...
        <section>
          <h2 className="text-xl font-semibold mb-4 flex items-center gap-2">
            <span className="w-7 h-7 rounded-full bg-gold-500/20 text-gold-400 text-sm flex items-center justify-center font-bold">2</span>
          ...
          <div className="space-y-3">
            {[
              ...
              { status: 'Ожидает оплаты', color: 'text-gold-300', bg: 'bg-gold-500/5 border-gold-500/20', text: 'Внесите платёж в течение 2 дней. В кабинете (Заказы → К оплате): укажите сумму, дату/время и нажмите «Я оплатил(а) — отправить». Организатор проверит.' },
        ...
        <section>
          <h2 className="text-xl font-semibold mb-4 flex items-center gap-2">
            <span className="w-7 h-7 rounded-full bg-gold-500/20 text-gold-400 text-sm flex items-center justify-center font-bold">3</span>
        ...
        <section className="bg-white/3 border border-white/8 rounded-2xl px-6 py-5 flex flex-col sm:flex-row sm:items-center gap-4">
          ...
          <div className="flex gap-3 flex-wrap shrink-0">
            <Link to="/offer"
              className="text-gold-400 hover:text-gold-300 text-sm border border-gold-500/30 hover:border-gold-400/50 px-4 py-2 rounded-lg transition-colors whitespace-nowrap">
              Договор оферты
            </Link>
            <Link to="/rules"
        ...
        <div className="border-t border-white/10 pt-10 flex flex-col sm:flex-row gap-4 items-center">
          ...
          <Link to="/catalog"
            className="px-6 py-3 bg-gold-500 hover:bg-gold-600 text-white font-semibold rounded-xl transition-colors text-sm">
            Перейти в каталог
          </Link>
        </div>
