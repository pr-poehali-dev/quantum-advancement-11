  ...
  return (
    <div className="min-h-screen bg-choco-950 text-white">
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-8 py-10 sm:py-16 space-y-8">
        ...
        <div className="bg-gold-500/8 border border-gold-500/20 rounded-2xl px-6 py-4 flex gap-3">
          <Icon name="Info" size={16} className="text-gold-400 shrink-0 mt-0.5" />
          <p className="text-white/60 text-sm leading-relaxed">
            Правила дополняют <Link to="/offer" className="text-gold-400 hover:underline">Договор публичной оферты</Link>. Участвуя в распивах и совместных закупках, вы соглашаетесь с обоими документами.
          </p>
        </div>
        ...
        <div className="space-y-6 text-white/70 leading-relaxed">
          ...
          <section className="bg-white/5 border border-white/10 rounded-2xl p-6 space-y-3">
            ...
            <ul className="space-y-1.5 text-sm">
              <li className="flex gap-2"><span className="text-gold-400 shrink-0">—</span>Минимальный заказ — 1 мл.</li>
              <li className="flex gap-2"><span className="text-gold-400 shrink-0">—</span>Объём указывается в момент оформления заявки и фиксируется после подтверждения оплаты.</li>
              <li className="flex gap-2"><span className="text-gold-400 shrink-0">—</span>Изменить объём можно до перехода заказа в статус «Зафиксирован».</li>
              <li className="flex gap-2"><span className="text-gold-400 shrink-0">—</span>Отливанты разливаются в чистые флаконы; допустимое отклонение объёма — ±5%.</li>
            </ul>
          </section>
          ...
          <section className="bg-white/5 border border-white/10 rounded-2xl p-6 space-y-3">
            ...
            <ul className="space-y-1.5 text-sm">
              <li className="flex gap-2"><span className="text-gold-400 shrink-0">—</span>Цена за мл фиксируется на момент оформления заявки.</li>
              <li className="flex gap-2"><span className="text-gold-400 shrink-0">—</span>Если закупка не состоялась (не набран минимальный объём), все оплаченные средства возвращаются участникам.</li>
              <li className="flex gap-2"><span className="text-gold-400 shrink-0">—</span>Сроки сбора объявляются Организатором заранее.</li>
            </ul>
          </section>
          ...
          <section className="bg-white/5 border border-white/10 rounded-2xl p-6 space-y-3">
            ...
            <ul className="space-y-1.5 text-sm">
              <li className="flex gap-2"><span className="text-gold-400 shrink-0">—</span>Общение в уважительном тоне — как с Организатором, так и с другими участниками.</li>
              <li className="flex gap-2"><span className="text-gold-400 shrink-0">—</span>Запрещено публиковать спам, рекламу сторонних ресурсов без согласования.</li>
              <li className="flex gap-2"><span className="text-gold-400 shrink-0">—</span>Претензии к качеству или объёму следует направлять через личный кабинет (раздел «Сообщения»), а не публично.</li>
              <li className="flex gap-2"><span className="text-gold-400 shrink-0">—</span>Систематическое нарушение правил может повлечь ограничение доступа к сервису.</li>
            </ul>
          </section>
        ...
        <div className="border-t border-white/10 pt-8 flex flex-wrap gap-4">
          <Link to="/offer" className="text-gold-400 hover:text-gold-300 text-sm transition-colors">
            Договор оферты →
          </Link>
