        ...
        <div className="space-y-3">
          <div className="flex gap-2 items-center flex-wrap">
            <input
              ...
              className="bg-white/5 border border-white/10 text-white placeholder:text-white/30 rounded-lg px-3 py-1.5 text-sm outline-none focus:border-orange-500/50 w-52"
            />
                ...
                <tbody>
                  {products.map(p => (
                    <tr key={p.id} className="border-b border-white/5 hover:bg-white/3">
                      ...
                      <td className="text-right pr-4 text-orange-300 font-mono">{p.booked_ml.toFixed(1)} мл</td>
          ...
          <div className="flex gap-2 flex-wrap items-end">
            <div>
              ...
              <select value={movType} onChange={e => setMovType(e.target.value)}
                className="bg-white/5 border border-white/10 text-white rounded-lg px-3 py-1.5 text-sm outline-none focus:border-orange-500/50">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <div>
              ...
              <input value={docNumber} onChange={e => setDocNumber(e.target.value)}
                ...
                className="w-full bg-white/5 border border-white/10 text-white placeholder:text-white/20 rounded-lg px-3 py-2 text-sm outline-none focus:border-orange-500/50" />
            </div>
            <div>
                    ...
                    <tr key={item.product_id} className="border-b border-white/5 last:border-0">
                      ...
                      <td className="px-3 py-2">
                        <input
                          ...
                          placeholder="0"
                          className="w-full bg-white/5 border border-white/10 text-white rounded-lg px-2 py-1 text-sm outline-none focus:border-orange-500/50 text-right"
                        />
                      </td>
                      <td className="px-2">
